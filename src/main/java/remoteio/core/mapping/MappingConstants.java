...
public class MappingConstants {
    ...
    public static class Type {
        ...
        public static final String[] TESSELLATOR_VERTEX_STATE = new String[] {
                "net/minecraft/client/shader/TesselatorVertexState", "bmi" };
    ...
    public static class Method {
        ...
        public static final String[] GET_INDIRECT_POWER_LEVEL_TO = new String[] { "getIndirectPowerLevelTo",
                "func_72878_l", "g" };
        ...
        public static class Desc {
            ...
            // [0]: Deobfuscated
            // [1]: Obfuscated
            public static final String[] GET_VERTEX_STATE = new String[] {
                    "(FFF)Lnet/minecraft/client/shader/TesselatorVertexState;", "(FFF)Lbmi;" };
